...
public class AddNewEmployeeServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Matcher matcher = pattern1.matcher(departmentString);
        ...
        matcher = pattern1.matcher(personalNumberString);
        ...
        else if(isStringContainsSpecialCharacter)alertService.add(Alert.Type.danger,"Surname cannot contains special characters or numbers.");
        ...
        else if(!profession.equals("admin")&&!profession.equals("Zdravotnicky Personal")&&!profession.equals("Technicky personal")) alertService.add(Alert.Type.danger,
                "Invalid profession, choose one from (admin,Technicky personal,Zdravotnicky Personal)");
        else
            {
                int department=0;
