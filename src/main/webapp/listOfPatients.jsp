                    ...
                    <div class="col-10">
                        ...
                        <table class="table table-light table-striped table-hover">
                            ...
                            <c:forEach var="patient" items="${patientService.listOfPatient}">
                                <c:set var="room" value="${roomService.getRoom(patient.roomid)}"/>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editPatient.jsp?pacientBirthNumber=${patient.pacientBirthnumber}" class="btn btn-primary">Edit</a><a href="listOfPrescriptions.jsp?pacientBirthNumber=${patient.pacientBirthnumber}" class="btn btn-secondary">Prescriptions</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
