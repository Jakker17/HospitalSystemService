                        ...
                        <table class="table table-light table-striped table-hover">
                            ...
                            <c:forEach var="patient" items="${patientService.listOfPatient}">
                                ...
                                <tr>
                                    ...
                                    <td><a href="editPatient.jsp?pacientBirthNumber=${patient.pacientBirthnumber}" class="btn btn-primary">Upravit</a><a href="listOfPrescriptions.jsp?pacientBirthNumber=${patient.pacientBirthnumber}" class="btn btn-secondary">Předpisy</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
